...
<div class="recent-orders mb-5">
    <h2 class="subtitle">Inicios | Marcas</h2>
    <button class="add ml-2 mt-2 mb-4 add" type="button" onclick="frmMarca();"><span class="material-symbols-outlined">add</span></button>
    <div class="recent-orders text-center table-3">
        <table class="text-center table-container" id="tblMarcas">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header ba-primary">
                <h5 class="modal-title title-modal" id="title">Nueva Marca</h5>
            </div>
            <div class="modal-body">
                <form method="post" id="frmMarca">
                    ...
                    <br>
                    <button class="add" type="button" onclick="registrarMar(event);" id="btnAccion">Registrar</button>
                </form>
            </div>
        </div>
    </div>
